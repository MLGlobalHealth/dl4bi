...
Models:
  ...
  - FM-DeepRV K=1,3,5,10  (each independently trained)
...
def main(seed: int = 42, gt_ls: int = 10):
    ...
    models = {
        ...
        "FM-DeepRV (5 steps)": (
            FlowMatchingDeepRV(vf=FlowMatchingVectorField(num_blks=2), n_steps=5),
            flow_matching_train_step,
            flow_matching_valid_step,
        ),
        "FM-DeepRV (10 steps)": (
            FlowMatchingDeepRV(vf=FlowMatchingVectorField(num_blks=2), n_steps=10),
            flow_matching_train_step,
            flow_matching_valid_step,
        ),
    }
